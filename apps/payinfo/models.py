...
class PayinfoOrder(models.Model):
    ...
    payinfo = models.ForeignKey('PayInfo', on_delete=models.CASCADE, related_name='payinfo_order')
    buyer = models.ForeignKey('xfzauth.User', on_delete=models.CASCADE, related_name='payinfo_buyer')
